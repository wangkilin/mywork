...
<div class="col-sm-12 widget-container-span">
	<div class="widget-box transparent">
		<div class="widget-header">
			<div class="widget-toolbar no-border">
				<ul class="nav nav-tabs" id="myTab">
					<li class="active"><a data-toggle="tab" href="#home1">幻灯片管理</a></li>
			...
			<div class="widget-main padding-12 no-padding-left no-padding-right">
				<div class="tab-content padding-4">
								...
								<div class="table-responsive">
									<table id="sample-table-1"
										...
										<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$result): $mod = ($i % 2 );++$i;?><tr>
												...
												<td><a href="javascript:void(0);" onclick="reGood(<?php echo ($result["id"]); ?>);" class="btn btn-white btn-sm">修改</a><a class="J_ajax_del btn btn-white btn-sm" href="<?php echo U('Admin/Hdp/delgood',array('id'=>$result['id']));?>">删除</a></td>
					...
					<div id="home2" class="tab-pane in">
						<form class="form-horizontal J_ajaxForm" enctype="multipart/form-data" id="myform" action="<?php echo U('Admin/Hdp/addgood');?>" method="post">
							<div class="tabbable">
									...
									<div class="tab-pane active">
										<table cellpadding="2" cellspacing="2" width="100%">
											<tbody>
												...
												<tr>
													<td>url:</td>
													<td><input type="text" class="input col-sm-2" name="url" value=""></td>
												</tr>
		...
		<script type="text/javascript">
			...
			function reGood(o) {
				var goodid = o;
				$.post("<?php echo U('Admin/Hdp/getgoodid');?>",{"id":goodid},function(data){
					var json = eval(data);
					...
					if (flag) {
						$('input[name="title"]').parent().append('<input type="hidden" name="goodid" value="'+json.id+'">');
						$('input[name="addimage"]').parent().append('<img src="__PUBLIC__/Uploads/'+json.img+'" id="goodimage" style="max-width:650px" class="img-thumbnail">');
						flag = false;
					}else{
						$('input[name="goodid"]').val(json.id);
						$('#goodimage').attr("src","__PUBLIC__/Uploads/"+json.img);
					}
				});
