...
<div class="main-container" id="main-container">
	...
	<ul class="nav nav-list">
		...
		<li>
			<a href="javascript:void(0)" target="#main_iframe"><i class="icon-group"></i><span class="menu-text"> 文章管理 </span></a>
		</li>	

		<li>
			<a href="javascript:void(0)" target="#main_iframe"><i class="icon-group"></i><span class="menu-text"> 机器人管理 </span></a>
		</li>
		<li>
			<a href="javascript:void(0)" target="#main_iframe"><i class="icon-group"></i><span class="menu-text"> 云支付管理 </span></a>
		</li>
		<li>
			<a href="javascript:void(0)" target="#main_iframe"><i class="icon-group"></i><span class="menu-text"> 清货分类管理 </span></a>
		</li>
		<li>
			<a href="javascript:void(0)" target="#main_iframe"><i class="icon-group"></i><span class="menu-text"> 清货时间管理 </span></a>
		</li>
		<li>
			<a href="javascript:void(0)" target="#main_iframe"><i class="icon-group"></i><span class="menu-text"> 清货商品管理 </span></a>
		</li>
		<li>
			<a href="javascript:void(0)" target="#main_iframe"><i class="icon-group"></i><span class="menu-text"> 商城幻灯片管理 </span></a>
		</li>
	...
	<script type="text/javascript">
		...
		$('.nav.nav-list li').eq(7).click(function() {
			...
			$('#main_iframe').attr("src","/hufen/orderlist.php");
		});
		$('.nav.nav-list li').eq(8).click(function() {
			$('.nav.nav-list li').removeClass('active');
			$(this).addClass('active');
			$('#breadcrumbs ul li').eq(1).html('文章管理');
			$('#main_iframe').attr("src","<?php echo U('Admin/Content/index');?>");
		});
		$('.nav.nav-list li').eq(9).click(function() {
			$('.nav.nav-list li').removeClass('active');
			$(this).addClass('active');
			$('#breadcrumbs ul li').eq(1).html('机器人管理');
			$('#main_iframe').attr("src","<?php echo U('Admin/Xiaoi/index');?>");
		});
		$('.nav.nav-list li').eq(10).click(function() {
			$('.nav.nav-list li').removeClass('active');
			$(this).addClass('active');
			$('#breadcrumbs ul li').eq(1).html('云支付管理');
			$('#main_iframe').attr("src","<?php echo U('Admin/Yunpay/index');?>");
		});
		$('.nav.nav-list li').eq(11).click(function() {
			$('.nav.nav-list li').removeClass('active');
			$(this).addClass('active');
			$('#breadcrumbs ul li').eq(1).html('清货分类管理');
			$('#main_iframe').attr("src","<?php echo U('Admin/Qinghuo/cat');?>");
		});
		$('.nav.nav-list li').eq(12).click(function() {
			$('.nav.nav-list li').removeClass('active');
			$(this).addClass('active');
			$('#breadcrumbs ul li').eq(1).html('清货时间管理');
			$('#main_iframe').attr("src","<?php echo U('Admin/Qinghuo/zdtime');?>");
		});
		$('.nav.nav-list li').eq(13).click(function() {
			$('.nav.nav-list li').removeClass('active');
			$(this).addClass('active');
			$('#breadcrumbs ul li').eq(1).html('清货商品管理');
			$('#main_iframe').attr("src","<?php echo U('Admin/Qinghuo/index');?>");
		});
		$('.nav.nav-list li').eq(14).click(function() {
			$('.nav.nav-list li').removeClass('active');
			$(this).addClass('active');
			$('#breadcrumbs ul li').eq(1).html('商城幻灯片管理');
			$('#main_iframe').attr("src","<?php echo U('Admin/Hdp/index');?>");
		});
