		...
		<div class="widget-header">
			<div class="widget-toolbar no-border">
				<ul class="nav nav-tabs" id="myTab2">
					...
					<li><a data-toggle="tab" href="#home3">支付宝设置</>
								...
								<form class="form-horizontal" role="form" action="<?php echo U('Admin/Index/setting');?>" method="post">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											<!-- <a href="/index.php?g=Admin&m=Index&a=del&type=8" class="btn" type="reset">
												<i class="icon-undo bigger-110"></i> 清空缓存
											</a> -->
										</div>
									</div>
								</form>
						...
						<div class="row">
							<div class="col-xs-12 no-padding-right">
								<form class="form-horizontal" role="form" action="<?php echo U('Admin/Index/setalipay');?>" method="post">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"
											for="form-field-1"> 支付宝账号（邮箱）： </label>
