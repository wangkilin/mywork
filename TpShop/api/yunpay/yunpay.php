...
/**************************请求参数**************************/
        ...
        //付款金额
        $total_fee = floor($_GET['WIDtotal_fee']);//必填 需为整数

        //订单描述

        $body = $_GET['WIDsubject'];
		
		
		//服务器异步通知页面路径
        $nourl =  "http://".$_SERVER['SERVER_NAME']."/api/yunpay/no_url.php";;
        //需http://格式的完整路径，不能加?id=123这类自定义参数

        //页面跳转同步通知页面路径
        $reurl = "http://".$_SERVER['SERVER_NAME']."/api/yunpay/re_url.php";
