...
{	
	if($_POST['keywords']){
		$where = $where ." and (name like '%".$_POST['keywords']."%' or miaoshu like '%".$_POST['keywords']."%' or addr like '%".$_POST['keywords']."%' )";
	}
}else{
	$where ='';
}
...
<div > 
    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
			...
			<a class="button button-small bg-red" href="addfen.php">添加粉丝</a>	<a class="button button-small bg-red" href="orderlist2.php">群管理</a>
