...
if($_POST[wxtitle]){
	if($code_data){
		...
		$sql="INSERT INTO weixinqun (id,`name`,sex,photoimg,codeimg,addr,prov,city,miaoshu,cdate,uid,wxid,shuaxin2)" .
			"VALUES(
				0,
				'{$_POST["wxtitle"]}',
				'{$_POST["sex"]}',
		...
		<form action="add2.php" method="post" id="codeform" enctype="multipart/form-data">
			<ul class="upinfo">
				...
				<li class=""><b>性别：</b>
					...
					<li class=""><label style="font-size: 13px;line-height: 30px;">提交即接受<a href="about/contract.html" style="color:#ea222e;">《VIP会员协议》</a>和<a href="about/user_contract.html" style="color:#ea222e;">《平台服务协议》</a></label></li>
