...
class GoodAction extends PublicAction {
	...
	public function delgood() {
		if ($_GET ["id"]=="20"||$_GET ["id"]=="36") {
			$this->success ( "该商品是vip人脉商品，不能删除" );
			exit();
		}
	...
	public function setyongjin(){
		...
		$yongjin['yongjin_4'] = (int)$_POST['yongjin_4'];
		$yongjin['yongjin_5'] = (int)$_POST['yongjin_5'];
		$yongjin['yongjin_6'] = (int)$_POST['yongjin_6'];
