<?php if ($this->_var['best_goods']): ?>
  ...
  <?php $_from = $this->_var['best_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_21875000_1418143172');if (count($_from)):
 ...
 <dd class="hot_dd02" >
  <div class="hot_img"> <span class="hot1"></span>
        ...
        <div class="pic">   <a href="<?php echo $this->_var['goods_0_21875000_1418143172']['url']; ?>"><img src="<?php echo $this->_var['goods_0_21875000_1418143172']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods_0_21875000_1418143172']['name']); ?>" class="goodsimg" /></a></div>
          ...
          <?php endif; ?>
           </font><font class="bb"><?php echo $this->_var['goods_0_21875000_1418143172']['market_price']; ?></font>
           </p>
        </div>
        </div>
         <div class="hot_btn"><a href="javascript:addToCartShowDiv(<?php echo $this->_var['goods_0_21875000_1418143172']['id']; ?>,1,'best')"  ></a> </div>
      <div class="hot_line" > </div>
      <div class="sucess_joinCart" id="addtocartdialog_retui_<?php echo $this->_var['goods_0_21875000_1418143172']['id']; ?>_best">
