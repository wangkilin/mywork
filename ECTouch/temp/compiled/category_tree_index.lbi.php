<div class="left_nav">
        <div class="leftNav" id="J_mainCata">
          <ul>
            <?php $_from = $this->_var['categories_pro']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_0_84375000_1418143171');$this->_foreach['categories_pro'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['categories_pro']['total'] > 0):
    foreach ($_from AS $this->_var['cat_0_84375000_1418143171']):
        $this->_foreach['categories_pro']['iteration']++;
?>
            <li>
              <p class="leftNav_p0<?php echo $this->_foreach['categories_pro']['iteration']; ?>"><a class="a1" href="<?php echo $this->_var['cat_0_84375000_1418143171']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['cat_0_84375000_1418143171']['name']); ?>"><?php echo htmlspecialchars($this->_var['cat_0_84375000_1418143171']['name']); ?></a></p>
              <div class="childer_hide" >
                <?php $_from = $this->_var['cat_0_84375000_1418143171']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child');if (count($_from)):
...
?>
            ...
            <div class="leftSubNav_list_right">
              <dl>
                <?php $_from = $this->_var['cat_0_84375000_1418143171']['brands']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'brand');if (count($_from)):
