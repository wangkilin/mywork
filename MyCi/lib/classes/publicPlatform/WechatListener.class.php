...
require_once(dirname(__FILE__) . '/Wechat/WechatListenerAbstract.class.php');
require_once(dirname(__FILE__) . '/Wechat/WechatResponse.class.php');
require_once(dirname(__FILE__) . '/Wechat/WechatMusicResponse.class.php');
require_once(dirname(__FILE__) . '/Wechat/WechatNewsResponse.class.php');
require_once(dirname(__FILE__) . '/Wechat/WechatNewsArtical.class.php');
require_once(dirname(__FILE__) . '/Wechat/WechatVideoResponse.class.php');
require_once(dirname(__FILE__) . '/Wechat/WechatTextResponse.class.php');
require_once(dirname(__FILE__) . '/Wechat/WechatVoiceResponse.class.php');
...
class WechatListener extends WechatListenerAbstract
{
    ...
    protected function processVoice()
    {
        if($WechatResponseInstance = $this->callCallback('video')) {
            ...
            $this->replyText('收到了语音消息。mediaId：' . $this->getRequest('MediaId')
