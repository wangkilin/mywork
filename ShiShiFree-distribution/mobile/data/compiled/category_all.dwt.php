...
?>
    <li class="crow level1">
      <div class="crow_row">
        ...
        <div class="crow_title"> <?php if ($this->_var['cat']['cat_id']): ?> <span><?php echo htmlspecialchars($this->_var['cat']['name']); ?></span> <?php else: ?> <span><a href="<?php echo $this->_var['cat']['url']; ?>"><?php echo htmlspecialchars($this->_var['cat']['name']); ?><img src="<?php echo $this->_var['ectouch_themes']; ?>/images/ico_11.png"></a></span> <?php endif; ?> </div>
        <div>&nbsp;</div>
      </div>
    </li>
...
<?php echo $this->fetch('library/shishi_footer.lbi'); ?>
