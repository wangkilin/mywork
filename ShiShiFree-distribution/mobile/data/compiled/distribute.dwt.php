...
?>
      ...
      <li><span class="uninclude">&nbsp; &nbsp; </span><span>我的推广</span></li>
        ...
        -->
      <li><span class="uninclude">&nbsp; &nbsp; </span><span>我的佣金</span> <span class="person"><?php if ($this->_var['shishiall']['setmoney']): ?><?php echo $this->_var['shishiall']['setmoney']; ?><?php else: ?>0<?php endif; ?></span>
        <div class="son_list">
          <ul>
