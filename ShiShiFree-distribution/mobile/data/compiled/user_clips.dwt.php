...
<meta charset="utf-8" />
<title><?php echo $this->_var['page_title']; ?> 八度余温商城</title>
...
<section class="wrap message_list">
  ...
  <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
    <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
      ...
      <tr>
        <td> <?php echo $this->_var['lang']['order_number']; ?> <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/shishiwfx/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
