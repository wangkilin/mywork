...
<h1>
    <span class="action-span">添加新抽奖规则</span>
    <span class="action-span1"><?php echo $this->_var['wxch_lang']['cp_home']; ?></span><span id="search_id" class="action-span1"> - <?php echo $this->_var['wxch_lang']['ur_here']; ?> </span>
...
?>
     ...
     <!--  --><a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['pid']; ?>, '您确认要删除这个规则吗？')" title="移除"><img src="images/icon_drop.gif" border="0" height="16" width="16"></a><!--  --></span>
		...
		<h1><?php echo $this->_var['shishi_free']; ?></h1>
        <?php if ($this->_var['full_page']): ?>
    </div>
</form>
<!-- end prize form -->
