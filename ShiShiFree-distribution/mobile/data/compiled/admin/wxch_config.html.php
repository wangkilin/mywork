...
?>
    <tr>
        ...
        <td>
            <label><input type="text" name="<?php echo $this->_var['list']['cfg_name']; ?>" value="<?php echo $this->_var['list']['cfg_value']; ?>"/></label><?php if ($this->_var['list']['cfg_name'] == 'shishi_url'): ?><a href="http://jingyan.baidu.com/article/63acb44ae5da2f61fdc17e7b.html" target="_blank">点击查看制作教程</a><?php endif; ?>
        </td>
