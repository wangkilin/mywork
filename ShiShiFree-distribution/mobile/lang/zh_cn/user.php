...
$_LANG['affiliate_intro'][0] = '　　八度余温商城为鼓励推荐新用户注册，现开展<b>推荐注册分成</b>活动，活动流程如下：

　　１、将本站提供给您的推荐代码，发送到论坛、博客、微信上。
　　２、访问者点击链接，访问八度余温商城
　　３、在访问者点击链接的 <b>%d%s</b> 内，若该访问者在八度余温商城注册，即认定该用户是您推荐的，您将获得等级积分 <b>%d</b> 的奖励 (当您的等级积分超过 <b>%d</b> 时，不再获得奖励)。
　　４、该用户今后在本站的一切消费，您均能获得一定比例的提成。目前实行的提成总额为订单金额的 <b>%s</b> 、积分的 <b>%s</b> ，分配给您、推荐您的人等，具体分配规则请参阅 <b><a href="#myrecommend">我推荐的会员</a></b>。
　　５、提成由管理员人工审核发放，请您耐心等待。八度余温商城返现相当消费10000元的订单，提成100元-150元左右的利润分成。
　　６、您可以通过分成明细来查看您的介绍、分成情况。';
$_LANG['affiliate_intro'][1] = '　　八度余温商城为鼓励推荐新用户注册，现开展<b>推荐订单分成</b>活动，活动流程如下：
